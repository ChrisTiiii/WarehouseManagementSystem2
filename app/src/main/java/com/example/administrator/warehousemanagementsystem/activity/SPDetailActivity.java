                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (applyBean.getReviewList() != null) {
                                    ...
                                    if (review != -1)
                                        netServerImp.agreeReview(review, applyBean.getId());
                                }
                            }
                        });
                        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (purchaseBean.getReviewList() != null) {
                                    ...
                                    System.out.println("review:" + review);
                                    if (review != -1)
                                        netServerImp.agreeReview(review, purchaseBean.getId());
                                }
                            }
                        });
                        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (budgetBean.getReviewList() != null) {
                                    ...
                                    System.out.println("review:" + review);
                                    if (review != -1)
                                        netServerImp.agreeReview(review, budgetBean.getId());
                                }
                            }
                        });
                        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                        ...
                        new MaterialDialog.Builder(this)
                                ...
                                .input("拒绝理由", null, new MaterialDialog.InputCallback() {
                                    ...
                                    public void onInput(MaterialDialog dialog, CharSequence input) {
                                        ...
                                        System.out.println("review:" + review);
                                        if (review != -1)
                                            netServerImp.refuseReview(review, String.valueOf(input), applyBean.getId());
                                    }
                                })
                                .negativeText("取消")
                                .positiveText("确定")
                        ...
                        new MaterialDialog.Builder(this)
                                ...
                                .input("拒绝理由", null, new MaterialDialog.InputCallback() {
                                    ...
                                    public void onInput(MaterialDialog dialog, CharSequence input) {
                                        ...
                                        System.out.println("review:" + review);
                                        if (review != -1)
                                            netServerImp.refuseReview(review, String.valueOf(input), purchaseBean.getId());
                                    }
                                })
                                .negativeText("取消")
                                .positiveText("确定")
                        ...
                        new MaterialDialog.Builder(this)
                                ...
                                .input("拒绝理由", null, new MaterialDialog.InputCallback() {
                                    ...
                                    public void onInput(MaterialDialog dialog, CharSequence input) {
                                        ...
                                        if (review != -1)
                                            netServerImp.refuseReview(review, String.valueOf(input), budgetBean.getId());
                                    }
                                })
                                .negativeText("取消")
                                .positiveText("确定")
